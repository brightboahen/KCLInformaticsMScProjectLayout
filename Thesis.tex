%&latexf
\documentclass[isdraft, kclharvardbib]{kclthesis}  % notes see below
...
\title{A Web Application - Classroom Management Tool}
...
%\include{structure/acknowledgements} (Remember to uncomment this and also remove this comment)
\fancyhead{}
\fancyfoot{}
\pagestyle{fancy} 
...
%%%%% Declaration
%\include{structure/declaration} (Remember to uncomment this and also remove this comment)
%%%%% Appendix 
%\appendix (Remember to uncomment this and also remove this comment)
%\include{appendix/app_1} (Remember to uncomment this and also remove this comment)
